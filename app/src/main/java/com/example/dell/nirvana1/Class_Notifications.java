 ...
 */
public class Class_Notifications extends Fragment implements  LoaderManager.LoaderCallbacks<List<Notification>> {

    private static final String NF_REQUEST_URL = "http://192.168.43.215/json/new.php";
    private static final int NOTIFICATION_LOADER_ID = 2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_class__notifications, container, false);

        emptyView = rootView.findViewById(R.id.cempty_view);
        nf_listView = (ListView) rootView.findViewById(R.id.clist_notification);
        progress = (ProgressBar) rootView.findViewById(R.id.cprogress);
